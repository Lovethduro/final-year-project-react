...
export function PublicPageStyles() {
    return (
        <style>{`
            .about-page, .services-page, .products-page { background: #060B1A; min-height: 100vh; padding-top: 88px; overflow-x: hidden; font-family: ${FONT_BODY}; }
            ...
            .about-hero-overlay { position: absolute; inset: 0; background: linear-gradient(135deg, rgba(6,11,26,0.92) 0%, rgba(13,24,48,0.85) 50%, rgba(6,11,26,0.95) 100%); }
            .about-hero-grid {
            ...
            .about-hero-heading { font-family: ${FONT_DISPLAY}; font-weight: 800; font-size: clamp(36px, 5.5vw, 58px); color: #fff; line-height: 1.05; margin: 0 0 20px; }
            .about-hero-heading span { background: linear-gradient(135deg, #38BDF8, #2B5CE6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
            ...
            .about-btn--ghost { color: rgba(255,255,255,0.72); border: 0.5px solid rgba(255,255,255,0.2); background: transparent; }
            ...
            .about-collage-main { position: absolute; inset: 0; border-radius: 20px; overflow: hidden; border: 0.5px solid rgba(99,179,237,0.2); box-shadow: 0 32px 64px rgba(0,0,0,0.45); }
            ...
            .about-collage-float { position: absolute; border-radius: 14px; overflow: hidden; border: 2px solid rgba(6,11,26,0.8); box-shadow: 0 16px 40px rgba(0,0,0,0.5); }
            ...
            .about-collage-badge {
                position: absolute; bottom: 24px; right: -12px; z-index: 2; background: #0D1F3C;
                border: 0.5px solid rgba(56,189,248,0.3); border-radius: 14px; padding: 16px 22px; box-shadow: 0 20px 48px rgba(0,0,0,0.55);
            }
            ...
            .about-hero-stats-bar {
                ...
                border-radius: 16px; background: rgba(13,24,48,0.65); border: 0.5px solid rgba(99,179,237,0.15); backdrop-filter: blur(12px);
            }
            ...
            .about-impact-overlay { position: absolute; inset: 0; background: linear-gradient(90deg, rgba(6,11,26,0.94) 0%, rgba(6,11,26,0.7) 50%, rgba(6,11,26,0.94) 100%); }
            .about-impact-inner { position: relative; z-index: 1; max-width: 820px; margin: 0 auto; text-align: center; }
            .about-impact-quote { font-family: ${FONT_DISPLAY}; font-size: clamp(20px, 3.5vw, 28px); color: rgba(255,255,255,0.88); line-height: 1.55; margin: 0 0 32px; font-style: italic; }
            .about-impact-chips { display: flex; flex-wrap: wrap; justify-content: center; gap: 10px; }
            .about-impact-chips span { padding: 8px 18px; border-radius: 24px; font-size: 12px; color: rgba(255,255,255,0.65); background: rgba(43,92,230,0.15); border: 0.5px solid rgba(56,189,248,0.25); }
            ...
            .about-offering, .about-offering-card {
                ...
                border: 0.5px solid rgba(99,179,237,0.12); text-align: left; transition: all 0.3s ease;
            }
            .about-offering::before, .about-offering-card::before, .about-offering-btn::before {
                ...
                background: linear-gradient(90deg, #2B5CE6, #38BDF8); opacity: 0.7;
            }
            .about-offering:hover, .about-offering-card:hover { border-color: rgba(56,189,248,0.35); transform: translateY(-4px); box-shadow: 0 16px 40px rgba(0,0,0,0.25); }
            .about-offering-btn {
                position: relative; width: 100%; cursor: pointer; font-family: ${FONT_BODY};
                border: 0.5px solid rgba(99,179,237,0.12); background: #0D1830; border-radius: 16px;
                padding: 28px 24px; text-align: left; transition: all 0.3s ease;
            }
            .about-offering-btn:hover { border-color: rgba(56,189,248,0.38); transform: translateY(-4px); box-shadow: 0 20px 40px rgba(0,0,0,0.25); }
            ...
            .about-offering-num { font-size: 11px; color: rgba(255,255,255,0.28); font-weight: 600; }
            .about-offering h3, .about-offering-btn h3 { font-family: ${FONT_DISPLAY}; font-size: 18px; color: #fff; margin: 0 0 10px; font-weight: 600; }
            .about-offering p, .about-offering-btn p { margin: 0 0 14px; font-size: 14px; color: rgba(255,255,255,0.48); line-height: 1.65; }
            .about-offering ul, .about-offering-btn ul { margin: 0 0 18px; padding-left: 16px; color: rgba(255,255,255,0.4); font-size: 13px; line-height: 1.6; }
            .about-offering a, .about-offering-cta { font-size: 13px; font-weight: 600; color: #38BDF8; text-decoration: none; }
            .about-offering a:hover, .about-offering-cta { color: #fff; background: none; border: none; padding: 0; }
            ...
            .about-contact-card {
                background: #0D1830; border: 0.5px solid rgba(99,179,237,0.12); border-radius: 14px;
                padding: 24px 22px; text-align: left; transition: all 0.25s ease; text-decoration: none; color: inherit; display: block;
            }
            .about-contact-card:hover { border-color: rgba(56,189,248,0.35); transform: translateY(-3px); background: rgba(43,92,230,0.06); }
            .about-contact-label { font-size: 11px; letter-spacing: 0.14em; text-transform: uppercase; color: #38BDF8; margin-bottom: 10px; font-weight: 600; }
            .about-contact-card h3 { font-family: ${FONT_DISPLAY}; color: #fff; margin: 0 0 10px; font-size: 17px; font-weight: 600; }
            .about-contact-card p { color: rgba(255,255,255,0.5); margin: 0; font-size: 14px; line-height: 1.7; }
            .about-contact-action { display: inline-block; margin-top: 14px; font-size: 12px; font-weight: 600; color: #38BDF8; }
            .about-contact-aside { display: flex; flex-direction: column; gap: 16px; }
            .about-contact-panel { background: #0D1830; border: 0.5px solid rgba(99,179,237,0.12); border-radius: 14px; padding: 24px 22px; }
            .about-contact-panel h3 { font-family: ${FONT_DISPLAY}; color: #fff; margin: 0 0 14px; font-size: 16px; font-weight: 600; }
            .about-contact-panel ul { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; }
            .about-contact-panel li { display: flex; justify-content: space-between; gap: 12px; font-size: 13px; color: rgba(255,255,255,0.48); }
            .about-contact-panel li strong { color: rgba(255,255,255,0.78); font-weight: 600; }
            .about-contact-reviews { display: flex; justify-content: center; padding-top: 8px; }

            .about-closing { padding: clamp(56px, 8vw, 88px) 0 clamp(72px, 10vw, 104px); border-top: 0.5px solid rgba(99,179,237,0.08); }
            .about-closing-panel {
                display: grid; grid-template-columns: 1.05fr 0.95fr; gap: 0; border-radius: 22px; overflow: hidden;
                border: 0.5px solid rgba(99,179,237,0.16); background: #0D1830; box-shadow: 0 32px 64px rgba(0,0,0,0.28);
            }
            .about-closing-promise { padding: clamp(32px, 5vw, 48px); text-align: left; border-right: 0.5px solid rgba(99,179,237,0.1); }
            .about-closing-promise h2 { font-family: ${FONT_DISPLAY}; font-size: clamp(26px, 4vw, 36px); font-weight: 700; color: #fff; line-height: 1.1; margin: 0 0 16px; }
            .about-closing-promise h2 span { color: #38BDF8; }
            .about-closing-promise > p { font-size: 15px; color: rgba(255,255,255,0.52); line-height: 1.75; margin: 0 0 24px; max-width: 420px; }
            .about-closing-points { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; }
            .about-closing-points li { display: flex; align-items: center; gap: 10px; font-size: 13px; color: rgba(255,255,255,0.55); }
            .about-closing-points li::before { content: ''; width: 6px; height: 6px; border-radius: 50%; background: #38BDF8; box-shadow: 0 0 10px rgba(56,189,248,0.5); flex-shrink: 0; }
            .about-closing-action { padding: clamp(32px, 5vw, 48px); display: flex; flex-direction: column; justify-content: center; background: linear-gradient(160deg, rgba(43,92,230,0.22) 0%, rgba(13,24,48,0.4) 100%); }
            .about-closing-action h3 { font-family: ${FONT_DISPLAY}; font-size: clamp(20px, 3vw, 26px); color: #fff; margin: 0 0 12px; font-weight: 700; }
            .about-closing-action p { font-size: 14px; color: rgba(255,255,255,0.58); line-height: 1.7; margin: 0 0 28px; }
            ...
            .about-showcase-frame { border-radius: 22px; overflow: hidden; border: 0.5px solid rgba(99,179,237,0.2); box-shadow: 0 24px 48px rgba(0,0,0,0.35); }
