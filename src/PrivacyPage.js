            ...
            <div className="cyforce-public-page-inner">
                ...
                <div className="cyforce-public-card" style={{ marginBottom: "30px" }}>
                    <div style={{ marginBottom: "30px" }}>
                        ...
                        <p style={{ fontSize: "15px", color: "rgba(15,23,42,0.6)", lineHeight: "1.6", marginBottom: "16px" }}>
                    ...
                    <div style={{ marginBottom: "30px" }}>
                        ...
                        <ul style={{ fontSize: "15px", color: "rgba(15,23,42,0.6)", lineHeight: "1.6", marginLeft: "20px" }}>
